...
import { ChevronLeft, ChevronRight, Menu, Clock, User, BarChart2, Download, LogOut } from 'lucide-react'
      ...
      >
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="relative sm:hidden" ref={dropdownRef}>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 top-11 w-60 bg-[#1a1a1a] border border-white/10 rounded-2xl shadow-2xl overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-150">
                {/* User info header */}
                {user && (
